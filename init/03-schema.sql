...
-- Connect as superuser for extension creation
SET ROLE postgres;
...
--
-- Name: inventory_inventory_id_seq1; Type: SEQUENCE; Schema: bluebox; Owner: -
--

ALTER TABLE bluebox.inventory ALTER COLUMN inventory_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME bluebox.inventory_inventory_id_seq1
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: language_language_id_seq1; Type: SEQUENCE; Schema: bluebox; Owner: -
--

ALTER TABLE bluebox.language ALTER COLUMN language_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME bluebox.language_language_id_seq1
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: payment_payment_id_seq1; Type: SEQUENCE; Schema: bluebox; Owner: -
--

ALTER TABLE bluebox.payment ALTER COLUMN payment_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME bluebox.payment_payment_id_seq1
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: staff_staff_id_seq1; Type: SEQUENCE; Schema: bluebox; Owner: -
--

ALTER TABLE bluebox.staff ALTER COLUMN staff_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME bluebox.staff_staff_id_seq1
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
